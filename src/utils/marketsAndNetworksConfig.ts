...
export const STAGING_ENV = Number(process.env.NEXT_PUBLIC_CHAIN_ID) === CHAIN_SUPPORT.core_testnet;
export const PROD_ENV = Number(process.env.NEXT_PUBLIC_CHAIN_ID) === CHAIN_SUPPORT.core_mainnet;
