    ...
    <Paper>
      <Box sx={{ px: 6, pb: 4, pt: 4 }}>
        ...
        <Typography typography="description" sx={{ mt: 1 }} color="text.secondary">
          <Trans>
            All COLEND tokens have voting power, but in order to activate this voting power,
            COLEND/esCOLEND must first be delegated. Note: Delegation does not transfer token
            ownership, it only grants “Voting Power” to the delegated address. You can either
            self-delegate or delegate this voting power to others and you can change your delegation
            at anytime. To view active community members who are interested in receiving delegation.
          </Trans>
        </Typography>
        {disableButton ? (
          <Typography variant="description" color="text.muted" mt={6}>
            <Trans>You have no COLEND/esCOLEND to delegate.</Trans>
          </Typography>
        ) : (
          <>
            <DelegatedPower
