...
import { BigNumberValue, USD_DECIMALS, valueToBigNumber } from 'colend-math-utils';
  ...
  return (
    <PaperWrapper>
      ...
      {reserve.isFrozen || reserve.isPaused ? (
        ...
        <>
          <Divider sx={{ my: 6, borderColor: '#FFFFFF1A' }} />
          <Stack gap={3}>
            {!isGho && (
              <SupplyAction
                reserve={reserve}
                ...
                disable={
                  disableSupplyButton ||
                  (permissionSupply && permissionSupply[reserve.underlyingAsset] === false)
                }
  ...
  return (
    ...
    >
      <StyledTxModalToggleButton value={assetSymbol}>
        <Typography
          variant="buttonM"
          sx={{ color: `${selectedAsset === assetSymbol ? '#000' : '#CFD3E2'}` }}
        >
          {assetSymbol}
        </Typography>
      ...
      <StyledTxModalToggleButton value={baseAssetSymbol}>
        <Typography
          variant="buttonM"
          sx={{ color: `${selectedAsset === baseAssetSymbol ? '#000' : '#CFD3E2'}` }}
        >
          {baseAssetSymbol}
        </Typography>
      </StyledTxModalToggleButton>
